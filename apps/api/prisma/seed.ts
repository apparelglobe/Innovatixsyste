...
const DEMO_EMAIL = 'client@demo.innovatixsystems.com';
...
const STAFF_EMAIL = 'staff@innovatixsystems.com';
...
async function seedStaff(tenantId: string) {
  ...
  const engineers: [string, string, string, 'DELIVERY_LEAD' | 'ENGINEER'][] = [
    ['lead@innovatixsystems.com', 'Ava', 'Lead', 'DELIVERY_LEAD'],
    ['eng@innovatixsystems.com', 'Ravi', 'Eng', 'ENGINEER'],
  ];
