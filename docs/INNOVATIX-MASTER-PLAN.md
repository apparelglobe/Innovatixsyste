...
**Brand architecture (approved):** two public brands under Innovatix Group — **Innovatix Systems** (`innovatixmarketing.com`, software/AI/enterprise engineering — this plan) and **Innovatix Marketing** (separate domain/SEO/Ads — later track). Both share `platform-web` + `api`; separate front-ends and marketing sites.
...
4. `innovatixmarketing.com` registered/available for DNS.
